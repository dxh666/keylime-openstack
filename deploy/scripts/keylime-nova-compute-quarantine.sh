...
CALLER_COMPUTE_HOST="${COMPUTE_HOST:-}"
CALLER_COMPUTE_SERVICE="${COMPUTE_SERVICE:-}"
CALLER_DECISION_FILE="${DECISION_FILE:-}"

[ -f "$ENV_FILE" ] && source "$ENV_FILE"

[ -n "$CALLER_COMPUTE_HOST" ] && COMPUTE_HOST="$CALLER_COMPUTE_HOST"
[ -n "$CALLER_COMPUTE_SERVICE" ] && COMPUTE_SERVICE="$CALLER_COMPUTE_SERVICE"
